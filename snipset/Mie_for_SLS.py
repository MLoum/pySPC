...
if __name__ == "__main__":
    ...
    print("OK")
    m_Au_633 = 0.18344 + 3.4332j
    m_Ag_633 = 0.056206 + 4.2776j
    m_Latex_633 = 1.5875
    ...
    theta, SL, SR, SU = ScatteringFunction(m_Latex_633, wavelength, diameter=diameter, nMedium=nMedium, minAngle=minAngle, maxAngle=maxAngle)
    ...
    # qR, SLQ, SRQ, SUQ = ScatteringFunction(m, w, d, space='qspace')
    #
    # plt.close('all')
    #
    ...
    #
    # x_label = ["0", r"$\mathregular{\frac{\pi}{4}}$", r"$\mathregular{\frac{\pi}{2}}$", r"$\mathregular{\frac{3\pi}{4}}$",
    #            r"$\mathregular{\pi}$"]
